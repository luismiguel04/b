...
<body >
  ...
  <div class="container-fluid">
            <div class="page-header"style="background-color:lightskyblue;" >
                <h3 style="text-align: center "><p>Registro de puertos</p></h3>
...
<form id="registronaviera" class="form-horizontal" role="form" action="puertoregistrosql.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="codigo" placeholder="Codigo del puerto">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="firstname" class="col-md-3 control-label">Nombre</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="nombre" placeholder="Nombre del puerto">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="firstname" class="col-md-3 control-label">Ciudad</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="ciudad" placeholder="Ciudad del puerto">
                        </div>
                    </div>
