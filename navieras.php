...
<body >
  ...
  <div class="container-fluid">
            <div class="page-header"style="background-color:lightskyblue;" >
                <h3 style="text-align: center "><p>Listado de navieras</p></h3>
...
while ($mostrar=mysqli_fetch_array($resultado)){
            ...
            <tr>
               <td><?php echo $mostrar['codnaviera'] ?></td> 
               <td><?php echo $mostrar['nombre']?></td>
                <form  id="modifica" class="form-horizontal" role="form" action="navierasmodificar.php" method="post" >
                   
              
               <td><button name="numero" value="<?php echo $mostrar['codnaviera'] ?>" >Modificar </button></td>
             </form>
             <form  id="eliminar" class="form-horizontal" role="form"action="navieraseliminar.php"  method="post" >
                   
              
               <td><button name="codigo"  value="<?php echo $mostrar['codnaviera'] ?>" >Eliminar </button></td>
             </form>
