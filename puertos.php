...
<body >
  ...
  <div class="container-fluid">
            <div class="page-header"style="background-color:lightskyblue;" >
                <h3 style="text-align: center "><p>Listado de puertos</p></h3>
...
while ($mostrar=mysqli_fetch_array($resultado)){
            ...
            <tr>
               <td><?php echo $mostrar['codpuerto'] ?></td> 
               <td><?php echo $mostrar['nombre']?></td>
              <td><?php echo $mostrar['ciudad']?></td>
             <form  id="modifica" class="form-horizontal" role="form" action="puertomodificar.php" method="post" >
                   
              
               <td><button name="codigo" value="<?php echo $mostrar['codpuerto'] ?>" >Modificar </button></td>
             </form>
             <form  id="eliminar" class="form-horizontal" role="form"action="puertoeliminar.php"  method="post" >
                   
              
               <td><button name="codigo"  value="<?php echo $mostrar['codpuerto'] ?>" >Eliminar </button></td>
             </form>
