...
$query=('select * from naviera where codnaviera ="'.$cod.'"');
...
<form id="registronaviera" class="form-horizontal" role="form" action="navierasmodificarsql.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="codigo" placeholder="Codigo de la naviera" value="<?php echo $mostrar['codnaviera'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="firstname" class="col-md-3 control-label">Nombre</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="nombre" placeholder="Nombre de la naviera"value="<?php echo $mostrar['nombre']?>">
                        </div>
                    </div>
