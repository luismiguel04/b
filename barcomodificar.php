...
<body >
  ...
  <div class="container-fluid">
            <div class="page-header"style="background-color:lightskyblue;" >
                <h3 style="text-align: center "><p>Modificación de barcos</p></h3>
...
$query=('select * from barco where codbarco ="'.$cod.'"');
...
<form id="registronaviera" class="form-horizontal" role="form" action="barcomodificarsql.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="codigo" placeholder="Codigo del barco" value="<?php echo $mostrar['codbarco'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="firstname" class="col-md-3 control-label">Nombre</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="nombre" placeholder="Nombre del barco"value="<?php echo $mostrar['nombre']?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="firstname" class="col-md-3 control-label">Capacidad de contenedores</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="capacidad" placeholder="Capacidad del barco" value="<?php echo $mostrar['capacidad']?>">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="firstname" class="col-md-3 control-label">Espacio</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="espacio" placeholder="Espacio del barco" value="<?php echo $mostrar['espacio']?>">
                        </div>
                    </div>
                    <?php
                       }
