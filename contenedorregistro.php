...
<body >
  ...
  <div class="container-fluid">
            <div class="page-header"style="background-color:lightskyblue;" >
                <h3 style="text-align: center "><p>Registro de contenedor</p></h3>
...
<form id="registronaviera" class="form-horizontal" role="form" action="contenedorregistrosql.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="numero" placeholder="Numero de contenedor">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="capacidad" placeholder="Capacidad de contenedor">
                        </div>
                    </div>
