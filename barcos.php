...
<body >
  ...
  <div class="container-fluid">
            <div class="page-header"style="background-color:lightskyblue;" >
                <h3 style="text-align: center "><p>Listado de barcos</p></h3>
...
while ($mostrar=mysqli_fetch_array($resultado)){
            ...
            <tr>
               ...
               <form  id="modifica" class="form-horizontal" role="form" action="barcomodificar.php" method="post" >
                   
              
               <td><button name="codigo" value="<?php echo $mostrar['codbarco'] ?>" >Modificar </button></td>
             </form>
             <form  id="eliminar" class="form-horizontal" role="form"action="barcoeliminar.php"  method="post" >
                   
              
               <td><button name="codigo"  value="<?php echo $mostrar['codbarco'] ?>" >Eliminar </button></td>
             </form>
