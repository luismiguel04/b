...
<body >
  ...
  <div class="container-fluid">
            <div class="page-header"style="background-color:lightskyblue;" >
                <h3 style="text-align: center "><p>Registro de naviera</p></h3>
...
<form id="registronaviera" class="form-horizontal" role="form" action="navieraregistrosql.php" method="post">
