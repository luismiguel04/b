...
<body >
  ...
  <div class="container-fluid">
            <div class="page-header"style="background-color:lightskyblue;" >
                <h3 style="text-align: center "><p>Listado de contenedores</p></h3>
...
while ($mostrar=mysqli_fetch_array($resultado)){
            ...
            <tr>
             ...
             <form  id="modifica" class="form-horizontal" role="form" action="contenedormodificar.php" method="post" >
                   
              
               <td><button name="numero" value="<?php echo $mostrar['numero'] ?>" >Modificar </button></td>
             </form>
             <form  id="eliminar" class="form-horizontal" role="form"action="contenedoreliminar.php"  method="post" >
                   
              
               <td><button name="codigo"  value="<?php echo $mostrar['numero'] ?>" >Eliminar </button></td>
             </form>
